...
**Connected API URL:** `https://ttfcw5hak8.execute-api.us-east-1.amazonaws.com/prod`
...
| API Gateway | ✅ Deployed | `https://ttfcw5hak8.execute-api.us-east-1.amazonaws.com/prod` |
