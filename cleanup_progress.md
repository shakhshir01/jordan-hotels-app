...
## Lambda Functions (35 to delete)
- [x] VisitJo-DestinationsFunction-C59z3SNJBcPI
- [ ] visitjo-user-UserFunction-8fQOXs6usBuQ
- [x] VisitJo-ChatFunction-xC6aV8zJKS31
- [x] VisitJo-GetHotelByIdFunction-stHsGhEfSneu
