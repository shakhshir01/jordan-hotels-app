...
```powershell
# Windows PowerShell
$apiUrl = "https://g7itqnbol9.execute-api.us-east-1.amazonaws.com/stage"
...
curl -v https://g7itqnbol9.execute-api.us-east-1.amazonaws.com/stage/hotels
...
```powershell
# Test response time
time curl https://g7itqnbol9.execute-api.us-east-1.amazonaws.com/stage/hotels
```
