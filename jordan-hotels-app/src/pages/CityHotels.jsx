  ...
  return (
    <div className="min-h-screen bg-light-cool dark:bg-dark-cool">
      <Seo
        ...
        canonicalUrl={`https://visitjo.com/cities/${city}/hotels`}
              ...
              {filteredHotels.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredHotels.map((hotel) => (
                    <div key={hotel.id} className="card-modern overflow-hidden hover:shadow-premium transition-all duration-300 hover:-translate-y-1">
